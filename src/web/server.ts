...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #111827; color: #cdd2d8; min-height: 100vh; padding: 2rem 1rem; }
  .container { max-width: 900px; margin: 0 auto; }
  h1 { font-size: 1.5rem; font-weight: 600; margin-bottom: 0.25rem; color: #ffffff; }
  ...
  .subtitle { color: #cdd2d8; font-size: 0.875rem; margin-bottom: 0; }
  .steps { display: flex; gap: 1.5rem; margin-bottom: 2rem; }
  .step { display: flex; align-items: center; gap: 0.5rem; font-size: 0.8125rem; color: #9ca3af; }
  .step-num { background: #4b5563; color: #ffffff; width: 1.5rem; height: 1.5rem; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; font-weight: 600; }
  .drop-zone { border: 2px dashed #4b5563; border-radius: 12px; padding: 3rem 2rem; text-align: center; cursor: pointer; transition: all 0.15s; }
  .drop-zone:hover, .drop-zone.dragover { border-color: #58a6ff; background: #374151; }
  .drop-zone p { color: #9ca3af; margin-top: 0.75rem; font-size: 0.875rem; }
  ...
  .file-chip { background: #374151; border: 1px solid #4b5563; border-radius: 6px; padding: 0.375rem 0.75rem; font-size: 0.8rem; display: flex; align-items: center; gap: 0.5rem; }
  ...
  .result-file { background: #374151; border: 1px solid #4b5563; border-radius: 8px; padding: 1rem 1.25rem; margin-bottom: 1rem; }
  .result-file h3 { font-size: 0.875rem; font-weight: 600; margin-bottom: 0.75rem; color: #ffffff; }
  .result-file.clean h3 { color: #3fb950; }
  .msg { padding: 0.5rem 0; border-bottom: 1px solid #1f2937; font-size: 0.8125rem; }
  ...
  .msg .rule { color: #6b7280; margin-left: 0.5rem; }
  .msg .suggestion { display: block; color: #9ca3af; margin-top: 0.25rem; padding-left: 1.75rem; font-size: 0.75rem; }
  .summary { margin-top: 1rem; padding: 0.75rem 1rem; background: #374151; border: 1px solid #4b5563; border-radius: 6px; font-size: 0.8125rem; }
  ...
  .preview-item .name { position: absolute; bottom: -1.25rem; left: 0; right: 0; text-align: center; font-size: 0.625rem; color: #9ca3af; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
</style>
</head>
<body>
<div class="container">
