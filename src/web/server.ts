...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .file-chip.clear-all { background: #da3633; border-color: #da3633; color: #fff; cursor: pointer; }
  .file-chip.clear-all:hover { background: #f85149; border-color: #f85149; }
  .btn { background: #238636; color: #fff; border: none; border-radius: 6px; padding: 0.625rem 1.25rem; font-size: 0.875rem; font-weight: 500; cursor: pointer; margin-top: 1.5rem; transition: background 0.15s; }
  .btn:hover { background: #2ea043; }
  .btn:disabled { background: #21262d; color: #484f58; cursor: not-allowed; }
  .btn-secondary { background: #1f6feb; }
  .btn-secondary:hover { background: #388bfd; }
  .btn-secondary:disabled { background: #21262d; color: #484f58; }
